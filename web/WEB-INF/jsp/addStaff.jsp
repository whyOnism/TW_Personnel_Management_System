            ...
            <form action="${pageContext.request.contextPath}/staff/addStaff" method="post">
                ...
                <div class="row gy-3">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="StaffPolitical" placeholder="StaffPolitical"
                               name="StaffPolitical">
                    </div>
                </div>
                <div class="row gy-3">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="StaffPosition" placeholder="StaffPosition"
                               name="StaffPosition">
                    </div>
                </div>
                <div class="row gy-3">
                ...
                <div class="row gy-3">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="StaffAddress" placeholder="StaffAddress"
                               name="StaffAddress">
                    </div>
                </div>
                <div class="row gy-3">
                ...
                <div class="row gy-3">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control" id="WorkingYears" placeholder="WorkingYears"
                               name="WorkingYears">
                    </div>
                </div>
                <hr class="my-4">
