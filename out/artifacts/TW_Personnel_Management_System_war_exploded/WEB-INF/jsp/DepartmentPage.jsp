                ...
                <div class="col-md-12 column">
                    ...
                    <div>
                        <ul class="pagination">
                            ...
                            <li class="<c:if test="${!pageDepartment.isHasPrevious()}">disabled</c:if> page-item">
                                <a href="?start=${pageDepartment.getStart()-pageDepartment.getCount()}" aria-label="Previous"
                                   class="page-link">
                            ...
                            <li class="<c:if test="${!pageDepartment.isHasNext()}">disabled</c:if> page-item">
                                <a href="?start=${pageDepartment.getStart()+pageDepartment.getCount()}" aria-label="Next" class="page-link">
                                    <span aria-hidden="true">›</span>
                                </a>
                            </li>
                            <li class="<c:if test="${!pageDepartment.isHasNext()}">disabled</c:if> page-item">
